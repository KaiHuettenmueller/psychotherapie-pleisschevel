          ...
          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            ...
            <div className="space-y-2">
              <div className="flex items-start gap-3">
                ...
                />
                <Label htmlFor="privacy" className="text-sm leading-relaxed cursor-pointer inline">
                  Ich habe die <Link href="/datenschutz" className="text-primary underline underline-offset-4 hover:text-primary/80 inline">Datenschutzhinweise</Link> gelesen und stimme der Verarbeitung meiner Daten zu.
                </Label>
              </div>
              {errors.privacy && (
